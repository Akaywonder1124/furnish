...
export default function Hero() {
  return (
    <div
      className="relative h-screen max-md:bg-initial bg-cover bg-center flex justify-center items-center -z-10"
      style={{ backgroundImage: `url(${heroImage})` }}
    >
      <div className="absolute bg-[#FFF3E3] p-10  max-w-xl flex flex-col items-start justify-center shadow-lg top-1/3 lg:top-1/4  lg:right-20">
